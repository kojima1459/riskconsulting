...
Public Function SchemaS1() As String
    ...
    s = s & "      ""certainty"": {""type"": ""string"", ""enum"": [""confirmed"", ""assumed""]}" & vbLf
    s = s & "    }, ""required"": [""line_name"", ""coverage_summary"", ""limit_note"", ""special_note"", ""certainty""], ""additionalProperties"": false}}," & vbLf
    s = s & "    ""financials"": {""type"": ""object"", ""properties"": {" & vbLf
    s = s & "      ""fiscal_year"": {""type"": ""string""}," & vbLf
    s = s & "      ""net_assets"": {""type"": ""string""}," & vbLf
    s = s & "      ""sales"": {""type"": ""string""}," & vbLf
    s = s & "      ""operating_profit"": {""type"": ""string""}," & vbLf
    s = s & "      ""source"": {""type"": ""string"", ""enum"": [""yuho"", ""kessan_kokoku"", ""tdb"", ""view"", ""memo"", ""unknown""]}," & vbLf
    s = s & "      ""note"": {""type"": ""string""}" & vbLf
    s = s & "    }, ""required"": [""fiscal_year"", ""net_assets"", ""sales"", ""operating_profit"", ""source"", ""note""], ""additionalProperties"": false}," & vbLf
    ...
    s = s & "      ""kind"": {""type"": ""string"", ""enum"": [""conflict"", ""undisclosed"", ""not_found"", ""hearing_only""]}" & vbLf
    s = s & "    }, ""required"": [""item"", ""why_needed"", ""kind""], ""additionalProperties"": false}}," & vbLf
    ...
    s = s & "    ""sources"": {""type"": ""array"", ""maxItems"": 20, ""items"": {""type"": ""object"", ""properties"": {" & vbLf
    s = s & "      ""label"": {""type"": ""string""}," & vbLf
    s = s & "      ""url"": {""type"": ""string""}," & vbLf
    s = s & "      ""aspect"": {""type"": ""string"", ""enum"": [""profile"", ""business"", ""sites"", ""history"", ""news"", ""hr"", ""finance_risk"", ""sales_memo"", ""sns"", ""competitors"", ""market"", ""finance"", ""insurance_ctx"", ""hazard"", ""other""]}" & vbLf
    s = s & "    }, ""required"": [""label"", ""url"", ""aspect""], ""additionalProperties"": false}}" & vbLf
    s = s & "  }," & vbLf
    ...
    s = s & "               ""current_coverage"", ""financials"", ""field_insights"", ""missing_info"", ""input_quality""," & vbLf
    s = s & "               ""research_requests"", ""sources""]," & vbLf
...
Public Function SchemaS2() As String
    ...
    s = s & "        ""gap_note"": {""type"": ""string""}," & vbLf
    s = s & "        ""control_note"": {""type"": ""string""}" & vbLf
    s = s & "      }, ""required"": [""transferability"", ""line_note"", ""gap_note"", ""control_note""], ""additionalProperties"": false}," & vbLf
...
Public Function SchemaS3() As String
    ...
    s = s & "    ""growth_ideas"": {""type"": ""array"", ""minItems"": 4, ""maxItems"": 8," & vbLf
    s = s & "      ""items"": {""type"": ""object"", ""properties"": {" & vbLf
    s = s & "      ""title"": {""type"": ""string"", ""maxLength"": 30}," & vbLf
    s = s & "      ""what"": {""type"": ""string"", ""maxLength"": 100}," & vbLf
    s = s & "      ""why"": {""type"": ""string"", ""maxLength"": 100}," & vbLf
    s = s & "      ""insurance_fit"": {""type"": ""string""}," & vbLf
    s = s & "      ""effect"": {""type"": ""integer"", ""minimum"": 1, ""maximum"": 5}," & vbLf
    s = s & "      ""difficulty"": {""type"": ""string"", ""enum"": [""low"", ""mid"", ""high""]}" & vbLf
    s = s & "    }, ""required"": [""title"", ""what"", ""why"", ""insurance_fit"", ""effect"", ""difficulty""]," & vbLf
    s = s & "       ""additionalProperties"": false}}," & vbLf
    s = s & "    ""talk_script"": {""type"": ""object"", ""properties"": {" & vbLf
    s = s & "      ""opening"": {""type"": ""string"", ""maxLength"": 80}," & vbLf
    s = s & "      ""flow"": {""type"": ""array"", ""minItems"": 3, ""maxItems"": 5, ""items"": {""type"": ""string""}}," & vbLf
    s = s & "      ""closing"": {""type"": ""string""}," & vbLf
    s = s & "      ""taboo"": {""type"": ""array"", ""items"": {""type"": ""string""}}" & vbLf
    s = s & "    }, ""required"": [""opening"", ""flow"", ""closing"", ""taboo""], ""additionalProperties"": false}" & vbLf
    s = s & "  }," & vbLf
    s = s & "  ""required"": [""stories"", ""unmatched_risks"", ""do_not_propose"", ""growth_ideas"", ""talk_script""]," & vbLf
    s = s & "  ""additionalProperties"": false" & vbLf
    s = s & "}"
    SchemaS3 = s
End Function
