...
'   1行目は裁定書37 B-06 で**担当者確認前の既定文**へ改訂した(確認済みで
'   書き出したときだけ「担当者が確認・編集したものです（確認: …）」に
'   差し替わる。3項分岐そのものの検査は modTestsPure24)。
Private Const DISC1 As String = _
    "本資料はAIが公開情報等から作成した営業担当者向けの分析資料です" & _
    "（AI生成・担当者確認前）。お客さまへ提示する前に、" & _
    "担当者が内容を確認・編集してください。"
